 ...
 */
final class Version20240930141024 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE store ADD shopify_client_secret LONGTEXT DEFAULT NULL, CHANGE enabled enabled BOOLEAN DEFAULT false');
    }

    public function down(Schema $schema): void
    {
        // this down() migration is auto-generated, please modify it to your needs
        $this->addSql('ALTER TABLE store DROP shopify_client_secret, CHANGE enabled enabled TINYINT(1) DEFAULT 0');
