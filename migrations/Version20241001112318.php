 ...
 */
final class Version20241001112318 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE store ADD shopify_webhooks_configured BOOLEAN DEFAULT false, ADD shopify_carrier_service_configured BOOLEAN DEFAULT false, DROP shopify_configured, CHANGE enabled enabled BOOLEAN DEFAULT false');
    }

    public function down(Schema $schema): void
    {
        // this down() migration is auto-generated, please modify it to your needs
        $this->addSql('ALTER TABLE store ADD shopify_configured TINYINT(1) DEFAULT 0, DROP shopify_webhooks_configured, DROP shopify_carrier_service_configured, CHANGE enabled enabled TINYINT(1) DEFAULT 0');
